        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
          ...
          {messages.length === 0 ? (
            ...
            (
              ...
              >
                <p className="fixed top-8 border border-transparent hover:border-gray-500/50 py-1 rounded-lg font-semibold mb-6">{selectedChat.name}</p>
                  ...
                  isLoading && (
                    <div className="flex gap-4 max-w-3xl w-full py-3">
                      ...
                      <div className="loader flex justify-center items-center gap-1">
                        ...
                        </div><div className="w-1 h-1 rounded-full bg-white animate-bounce">
